...
load('parameters3V.mat');
parameters = parameters3V;
...
legend('1--2 Vehicle', '2--3 Vehicle');
...
legend('Vehicle 2', 'Vehicle 3');

Result_Feasible3V = struct;
Result_Feasible3V.Result_ht = Result_ht;
Result_Feasible3V.parameters = parameters;
save('Result_Feasible3V.mat', 'Result_Feasible3V');
