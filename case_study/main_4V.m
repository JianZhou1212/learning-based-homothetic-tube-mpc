...
legend('1--2 Vehicle', '2--3 Vehicle', '3--4 Vehicle');
...
legend('Vehicle 2', 'Vehicle 3', 'Vehicle 4');

Result_Feasible4V = struct;
Result_Feasible4V.Result_ht = Result_ht;
Result_Feasible4V.parameters = parameters;
save('Result_Feasible4V.mat', 'Result_Feasible4V');
